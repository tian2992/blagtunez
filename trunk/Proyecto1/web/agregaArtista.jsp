  ...
  <div class="span-15" id="main">
      ...
      <div>
          <form charset="UTF-8"  id="agregaArtista" action="artistaCreacion.jsp" method="POST">
              <fieldset>
              <label class="formCap">Nombre: </label><br /><input type="text" class="text" name="nombre" id="nombre" value="" size="20" /><br/>
              <label class="formCap">Nacionalidad: </label><br /><input type="text" class="text" name="nacionalidad" id="nacionalidad" value="" size="20" /><br />
              <label class="formCap">Genero: </label><br /><input type="text" class="text" name="genero" id="genero" value="" size="20" /><br />
              <label class="formcap formOpcional">Imagen: </label><br /><input type="text" class="text" name="imagen" id="imagen" value="" size="20" /><br />
